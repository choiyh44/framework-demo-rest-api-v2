...
public class JwtService {
    ...
    public String generateToken(UserDetail userDetail,List<String> roles,Long validMillis) {
		...
		return Jwts.builder()
			    ...
			    .setNotBefore(new Date(now - (validMillis != null ? validMillis : TOKEN_VALID_MILISECOND)))
			    .setExpiration(new Date(now + (validMillis != null ? validMillis : TOKEN_VALID_MILISECOND)))
			    .signWith(secretKey)
			    .compact();
    }
